...
ubsan_abort(const struct ubsan_source_location *location, const char *violation)
{
	...
	__print_str("filename = ");
	__print_str((char*)location->filename);
	__print_str("; line = ");
	__print_u64(location->line);
	__print_str("; column = ");
	__print_u64(location->column);
	__print_str("; violation = ");
	__print_str((char*)violation);
	__print_str(";\n");
